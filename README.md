...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,785 | 🐛 107 | 📅 2026-09-02
...
* Unity ML-Agents Toolkit \[[paper](https://arxiv.org/abs/1809.02627)] \[[code](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,702 | 🐛 21 | 🌐 C# | 📅 2026-09-25].
* OpenSpiel: A Framework for Reinforcement Learning in Games \[[paper](https://arxiv.org/abs/1908.09453)] \[[code](https://github.com/deepmind/open_spiel) ⭐ 5,503 | 🐛 64 | 🌐 C++ | 📅 2026-08-31].
* Alpha Zero General \[[code](https://github.com/suragnair/alpha-zero-general) ⭐ 4,518 | 🐛 75 | 🌐 Jupyter Notebook | 📅 2025-01-01].
* RLCard: A Toolkit for Reinforcement Learning in Card Games \[[paper](https://arxiv.org/abs/1910.04376)] \[[code](https://github.com/datamllab/rlcard) ⭐ 3,553 | 🐛 80 | 🌐 Python | 📅 2024-06-26].

### Texas Hold'em Projects

* Deep mind pokerbot for pokerstars and partypoker \[[code](https://github.com/dickreuter/Poker) ⭐ 2,466 | 🐛 34 | 🌐 Python | 📅 2025-06-26].
* DeepStack-Leduc \[[paper](https://arxiv.org/abs/1701.01724)] \[[code](https://github.com/lifrordi/DeepStack-Leduc) ⭐ 951 | 🐛 14 | 🌐 Lua | 📅 2018-01-06].
* PyPokerEngine \[[code](https://github.com/ishikota/PyPokerEngine) ⭐ 723 | 🐛 21 | 🌐 Python | 📅 2024-04-10].
* DeepHoldem \[[code](https://github.com/happypepper/DeepHoldem) ⭐ 223 | 🐛 24 | 🌐 Lua | 📅 2018-09-25].
...
* DouZero: Mastering DouDizhu with Self-Play Deep Reinforcement Learning \[[code](https://github.com/kwai/DouZero) ⭐ 4,666 | 🐛 35 | 🌐 Python | 📅 2024-06-26].
...
* PerfectDou: Dominating DouDizhu with Perfect Information Distillation \[[code](https://github.com/Netease-Games-AI-Lab-Guangzhou/PerfectDou) ⭐ 241 | 🐛 4 | 🌐 Python | 📅 2024-05-14].
...
* StarCraft II Learning Environment \[[paper](https://arxiv.org/abs/1708.04782)] \[[code](https://github.com/deepmind/pysc2) ⭐ 8,317 | 🐛 64 | 🌐 Python | 📅 2024-07-23].
* A reimplementation of Alphastar based on DI-engine with trained models \[[code](https://github.com/opendilab/DI-star) ⭐ 1,399 | 🐛 1 | 🌐 Python | 📅 2025-03-13].
...
* ELF: a platform for game research with AlphaGoZero/AlphaZero reimplementation \[[code](https://github.com/pytorch/ELF) ⚠️ Archived] \[[paper](https://arxiv.org/pdf/1902.04522.pdf)].

### Gomoku Projects

* AlphaZero-Gomoku \[[code](https://github.com/junxiaosong/AlphaZero_Gomoku) ⭐ 3,632 | 🐛 80 | 🌐 Python | 📅 2024-04-24].
* gobang \[[code](https://github.com/lihongxun945/gobang) ⭐ 1,806 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-17].

### Chess Projects

* Chess-Alpha-Zero \[[code](https://github.com/Zeta36/chess-alpha-zero) ⭐ 2,227 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2023-03-24].
* Simple chess AI \[[code](https://github.com/lhartikk/simple-chess-ai) ⭐ 946 | 🐛 9 | 🌐 JavaScript | 📅 2017-10-16].
* Deep Pink \[[code](https://github.com/erikbern/deep-pink) ⭐ 832 | 🐛 9 | 🌐 Python | 📅 2017-02-20].

### Chinese Chess Projects

* CCZero (中国象棋Zero) \[[code](https://github.com/NeymarL/ChineseChess-AlphaZero) ⭐ 1,248 | 🐛 26 | 🌐 Python | 📅 2023-03-24].

### Mahjong Projects

* Mortal \[[code](https://github.com/Equim-chan/Mortal) ⭐ 1,567 | 🐛 13 | 🌐 Rust | 📅 2025-09-28].
...
* DouZero: Mastering DouDizhu with Self-Play Deep Reinforcement Learning, ICML 2021 \[[paper](https://arxiv.org/abs/2106.06135)] \[[code](https://github.com/kwai/DouZero) ⭐ 4,666 | 🐛 35 | 🌐 Python | 📅 2024-06-26].
* PerfectDou: Dominating DouDizhu with Perfect Information Distillation, NeurIPS 2022 \[[paper](https://arxiv.org/abs/2203.16406)] \[[code](https://github.com/Netease-Games-AI-Lab-Guangzhou/PerfectDou) ⭐ 241 | 🐛 4 | 🌐 Python | 📅 2024-05-14].
...
* [Awesome Deep Reinforcement Learning](https://github.com/tigerneil/awesome-deep-rl) ⭐ 1,515 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-20
* [Awesome StarCraft AI](https://github.com/SKTBrain/awesome-starcraftAI) ⭐ 645 | 🐛 3 | 📅 2022-02-03
